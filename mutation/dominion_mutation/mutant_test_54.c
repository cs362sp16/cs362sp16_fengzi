...
/* XXX: original code was :     int count = state->handCount[player];//Get current hand count for player */
    int count = state->handCount[ 0 * player];//Get current hand count for player
    int deckCounter;
    if (DEBUG){//Debug statements
      printf("Current hand count: %d\n", count);
    }
