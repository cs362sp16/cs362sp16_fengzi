...
/* XXX: original code was :     deckCounter = state->deckCount[player];//Create holder for the deck count */
    deckCounter = state->deckCount[ -1 + player];//Create holder for the deck count
