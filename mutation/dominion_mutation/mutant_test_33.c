...
/* XXX: original code was : int f_concil_room(struct gameState *state, int currentPlayer, int handpos){ */
int f_concil_room(struct gameState *state, int currentPlayer, 0 *  int handpos){
	    int i;
