...
/* XXX: original code was : int initializeGame(int numPlayers, int kingdomCards[10], int randomSeed, */
int initializeGame(int numPlayers, int kingdomCards[ 0 * 10], int randomSeed,
