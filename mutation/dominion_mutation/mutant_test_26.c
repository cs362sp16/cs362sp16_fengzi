...
/* XXX: original code was : int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) */
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, 2 * int *bonus)
{
  int i;
  int j;
  int k;
...
int f_concil_room(struct gameState *state, int currentPlayer, int handpos){
	    int i;
...
int f_remodel(struct gameState *state, int currentPlayer, int choice1, int choice2, int handpos){
		int j;
			int i;
			    j = state->hand[currentPlayer][choice1];  //store card we will trash
...
int f_village(struct gameState *state, int currentPlayer, int handpos){
			        ...
			        drawCard(currentPlayer, state); 
				        //+2 Actions
				        state->numActions = state->numActions + 2; //2
