...
/* XXX: original code was : int f_smithy(struct gameState *state, int currentPlayer, int handpos){ */
int f_smithy(struct gameState *state, int currentPlayer, -1 *  int handpos){
		int i;
			//+3 Cards
		        for (i = 0; i < 3; i++)
				         {
